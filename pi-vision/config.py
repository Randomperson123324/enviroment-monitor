...
CONFIG = {
    ...
    "phone": {
        ...
        # ── ชั้นเดาเมื่อมองไม่เห็นข้อมือ (กล้องตั้งโต๊ะเห็นแค่หัวกับไหล่เป็นปกติ) ──
        # เป็นสัดส่วนของ**ความกว้างใบหน้า** · วัดสองแกนแยกกันโดยตั้งใจ เพราะมือของคน
        # อยู่ในแนวดิ่งใต้หัว ไม่ใช่เฉียงออกข้าง — เหตุผลเต็ม (พร้อมตัวเลขที่วัดได้จริง)
        # อยู่ที่ `_face_gap` ใน phone.py
        # ⚠️ ตัวที่ควรลดก่อนถ้าห้องนั่งชิดกันจนของบนโต๊ะข้าง ๆ ถูกนับมาให้ คือ face_side
