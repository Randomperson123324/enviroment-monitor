...
**ข้อจำกัดที่ต้องรู้:** นี่ไม่ใช่การจำหน้า (face recognition)
เดินออกจากเฟรมแล้วกลับเข้ามาใหม่จะได้ id ใหม่ — เป็นการออกแบบโดยตั้งใจ
เพื่อไม่ให้ระบบเก็บข้อมูลที่ระบุตัวบุคคลได้
(ดูหัวข้อความเป็นส่วนตัวใน docs/devices/camera.md)
"""
