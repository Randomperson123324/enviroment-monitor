...
**ทางเลือกขั้นสูง:** ถ้าอยากส่งค่าความดันจริงเข้า `set_ambient_pressure` แบบไดนามิก
ต้องหาแหล่งข้อมูลความกดอากาศเอง — โปรเจกต์นี้เคยดึงฟีดกรมอุตุฯ (TMD) ผ่าน `lib/gov.js`
แต่ถอดออกแล้ว เหลือเฉพาะข้อมูลน้ำ (ThaiWater · กรมชลประทาน) — และเป็นงาน optimization
