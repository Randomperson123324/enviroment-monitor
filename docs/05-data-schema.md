...
> ISO 8995-1 สำหรับโต๊ะอ่านเขียน) · ฝั่งเฟิร์มแวร์ `multi_sensor_esp32s3.ino` อ่าน
> BH1750 ได้แล้วแต่**พิมพ์ออก Serial อย่างเดียว ยังไม่มี WiFi/HTTP** จึงยังไม่มีค่าไหล
> เข้าเว็บ · หน้าเว็บซ่อนกราฟความสว่างไว้เองจนกว่าจะมีข้อมูลจริง (`hasSeriesData`)
