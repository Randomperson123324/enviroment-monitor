...
const DICT = {
  th: {
    ...
    ai: {
      ...
      local: 'ในเครื่อง',
      hintOverride: 'ใช้ Gemini key จากเบราว์เซอร์ (override)',
      hintServer: 'วิเคราะห์ผ่านเซิร์ฟเวอร์ (GEMINI_API_KEY)',
      hintLocal: 'โหมด local — ตั้ง GEMINI_API_KEY บนโฮสต์ หรือใส่ key ใน Settings',
      analyzing: '✨ Gemini กำลังวิเคราะห์...',
      waiting: '🤖 รอข้อมูลจากเซ็นเซอร์...',
      analyzeNow: 'วิเคราะห์ด้วย Gemini ตอนนี้',
      logFetching: 'ดึงข้อมูลล่าสุดจาก DB แล้ววิเคราะห์...',
      logDone: 'วิเคราะห์สำเร็จ ({src})',
      srcGemini: 'Gemini', srcLocal: 'ในเครื่อง',
  ...
  en: {
    ...
    ai: {
      ...
      local: 'Local',
      hintOverride: 'Using Gemini key from the browser (override)',
      hintServer: 'Analyzing via the server (GEMINI_API_KEY)',
      hintLocal: 'Local mode — set GEMINI_API_KEY on the host or add a key in Settings',
      analyzing: '✨ Gemini is analyzing...',
      waiting: '🤖 Waiting for sensor data...',
      analyzeNow: 'Analyze with Gemini now',
      logFetching: 'Fetching the latest data from the DB and analyzing...',
      logDone: 'Analysis complete ({src})',
      srcGemini: 'Gemini', srcLocal: 'local',
